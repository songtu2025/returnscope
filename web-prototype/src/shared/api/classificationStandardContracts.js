...
/** @typedef {{classification_key: string, source_row?: number, comment: string, category_a?: string, category_b?: string, changed: boolean, semantic_changed?: boolean, primary_changed?: boolean, baseline: ClassificationValidationSemanticResult, draft: ClassificationValidationSemanticResult, reference?: ClassificationValidationReference, reference_comparison?: ClassificationValidationReferenceComparison}} ClassificationStandardValidationItem */
...
/** @typedef {Record<string, unknown> & {sample_size: number, changed_count: number, changed_rate: number, semantic_changed_count?: number, semantic_changed_rate?: number, primary_changed_count?: number, primary_changed_rate?: number, coverage_count: number, coverage_rate: number, review_count: number, review_rate: number, unknown_count: number, unknown_rate: number, error_count: number, error_rate: number, reference_evaluation?: ClassificationValidationReferenceEvaluation}} ClassificationStandardValidationSummary */
/**
