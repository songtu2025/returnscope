...
def compile_fact_classification(
    ...
    *,
    ...
    for fact in facts:
        ...
        elif not _mapping_can_form_terminal(fact, mapping):
            disposition = mapping_disposition(fact, mapping)
            result.unknown_semantics.append(
                _unmapped_semantic(
                    fact,
...
def classify_facts(
    *,
    ...
    try:
        coverage_response = call(coverage_audit_messages(comment, facts, taxonomy))
        coverage_merge = merge_coverage_facts(
            facts,
            coverage_response,
            comment=comment,
            taxonomy=taxonomy,
